import { getCommissionData } from "../api/WageSettlement.ts";
...
const [agentDropdown, setAgentDropdown] = useState(false);
  ...
  {isSuperAdmin ? (
    ...
    />
          ...
          <Col>
            <Button size="sm" variant="danger" className={styles.operateBtn} onClick={handleSearch}>
              查询
            </Button>
            <Button size="sm" variant="secondary" className={styles.operateBtn} onClick={handleClear}>
              清空
            </Button>
          </Col>
        </Form>
