...
import { fetchInsuredExpirationList, updateInsuredExpirationDay } from "../api/insuredExpirationApi";
...
const InsuredExpirationPage: React.FC = () => {
  ...
  useEffect(() => {
    setLoading(true);
    setError(null);
    fetchInsuredExpirationList(displayName, days)
    ...
    <div className={styles.expirationPage}>
      <div className={styles.topBar}>
        <span className={styles.title}>
          已保客户即将到期 <span className={styles.count}>{list.length}</span> 人
        </span>
