...
import { fetchPotentialExpirationList, updatePotentialExpirationDay } from "../api/PotentialExpirationApi";
...
const COLUMNS = [
  ...
  { key: 'insuredName', label: '车主' },
  { key: 'insuredIdNumber', label: '车主证件' },
  { key: 'phone', label: '电话' },
...
const PotentialExpirationPage: React.FC = () => {
  ...
  useEffect(() => {
    setLoading(true);
    setError(null);
    fetchPotentialExpirationList(displayName, days)
    ...
    <div className={styles.expirationPage}>
      <div className={styles.topBar}>
        <span className={styles.title}>
          希望客户即将到期 <span className={styles.count}>{list.length}</span> 人
        </span>
